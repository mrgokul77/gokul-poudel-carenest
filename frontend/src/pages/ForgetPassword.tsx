    ...
    <div className="min-h-screen flex items-center justify-center bg-green-50">
      <form onSubmit={handleSubmit} className="w-full max-w-md px-6">
        ...
        <div className="mb-6">
          ...
          <input
            type="email"
            className="w-full bg-transparent border border-gray-300 rounded-md px-4 py-3 text-sm focus:outline-none focus:border-green-500"
        ...
        {/* Button */}
        <button
          className="w-full bg-green-500 hover:bg-green-600 text-white py-3 rounded-md font-semibold text-sm transition disabled:opacity-60"
          type="submit"
          disabled={cooldown > 0}
        >
        ...
        <p
          ...
          className="text-sm text-center text-green-600 mt-5 cursor-pointer hover:underline font-medium"
        >
          Back to Login
        </p>
      </form>
