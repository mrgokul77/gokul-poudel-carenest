...
const SERVICE_ICONS: { [key: string]: React.ElementType } = {
  ...
  "Hospital & Clinic Escort": Building2,
  "Physiotherapy Support": Activity,
};
...
const SERVICES_GUIDE = [
  ...
  { name: "Hospital & Clinic Escort", description: "Accompaniment to medical visits and follow-ups." },
  { name: "Physiotherapy Support", description: "Help with recovery exercises and gentle movement support." },
            ...
            <div className="lg:col-span-3 order-3">
              <div className="bg-green-50 border border-gray-200 rounded-xl p-5 sticky top-6">
                ...
                <p className="text-xs text-gray-500 mb-4">
                  Care services you can offer in your profile.
                </p>
